...
const ChartTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div style={{
      background: colores.card, border: '1px solid var(--border-glass)',
            ...
            {[
              {
                ...
                icon: <TrendingUp size={14} />, color: colores.green,
              },
              {
                label: 'Gastos año', value: formatCurrency(totalGastos),
                icon: <TrendingDown size={14} />, color: colores.rose,
              },
              {
              ...
              <div key={i} className="glass-card p-3 animate-enter" style={{ animationDelay: `${i * 0.05}s` }}>
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <p className="text-[9px] uppercase tracking-wider font-bold" style={{ color: colores.muted }}>
                    {s.label}
                  </p>
                </div>
                      ...
                      <div className="h-1.5 rounded-full" style={{ background: colores.track }}>
                        <div className="h-full rounded-full transition-all duration-700"
                          style={{
                            ...
                            background: cumple ? g.color : colores.rose,
                          }} />
                      </div>
                  ...
                  <table className="w-full" style={{ fontSize: 11 }}>
                      ...
                      <tr style={{ borderBottom: '1px solid colores.border' }}>
                        {['Mes', 'Ingresos', 'Gastos', 'Balance'].map((h, i) => (
                          <th key={h} className="pb-2 font-black uppercase"
                            style={{
                              color: colores.muted, fontSize: 9,
                    ...
                    <tbody>
                      {resumenMes.filter(m => m.Ingresos > 0 || m.Gastos > 0).map(m => {
                        ...
                        return (
                          <tr key={m.mes} style={{ borderBottom: '1px solid colores.border' }}>
                            ...
                            <td className="py-2 text-right font-bold" style={{ color: colores.rose, fontSize: 11 }}>
                              {formatCurrency(m.Gastos)}
                            </td>
                            <td className="py-2 text-right font-black" style={{
                              fontSize: 11,
                              color: bal >= 0 ? colores.green : colores.rose,
                            }}>
                      ...
                      <tr style={{ borderTop: '2px solid colores.border' }}>
                        ...
                        <td className="pt-2.5 text-right font-black" style={{ color: colores.rose, fontSize: 12 }}>
